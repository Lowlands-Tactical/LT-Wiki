...
??? info
    ...
    - De cursist weet wanneer het AT-wapen gereedgemaakt moet worden; bij directe voertuigdreiging, waarneming of op commando van GC/PC. 
...
De AT’er heeft kennis van verschillende voertuigen, AT-wapensystemen en munitietypes. De Anti-Tank specialist is samen met de grenadier ook degene die een wirecutter heeft om door hekken te knippen. Ook kunnen deze twee rollen voertuigen repareren voor het team.
...
## Schietprocedures
Om verwondingen aan jezelf of anderen te voorkomen houden we de schietprocedure aan bij het gebruik van AT. De AT’er maakt het AT-wapen gereed bij directe voertuigdreiging, eigen waarneming of op commando van de GC/PC. De volgende stappen worden gevolgd:
!!! info
    1.	De GC/PC roept ‘AT gereedmaken!’.
    ...
    5.	De GC/PC roept ‘Backblast clear’, wanneer er veilig geschoten kan worden.
...
!!! info
    ...
    6.	De GC/PC roept ‘Backblast clear’, wanneer er veilig geschoten kan worden.
...
![Afbeelding](img/3_3_anti_tank/nlaw.jpg){ width="600" }
![Afbeelding](img/3_3_anti_tank/nlaw zoom.jpg){ width="600" }
...
![Afbeelding](img/3_3_anti_tank/rpg.jpg){ width="600" }
![Afbeelding](img/3_3_anti_tank/m136.jpg){ width="600" }
![Afbeelding](img/3_3_anti_tank/rpg zoom.jpg){ width="600" }
...
![Afbeelding](img/3_3_anti_tank/panzerfaust.jpg)
...
![Javelin NV](img/3_3_anti_tank/javelin night.jpg){ width="600" }
/// caption
...
![Javelin FLTR](img/3_3_anti_tank/javelin FLTR.jpg){ width="600" }
/// caption
...
![Javelin FLTR](img/3_3_anti_tank/javelin FLTR lock.jpg){ width="600" }
/// caption
...
![Javelin FLTR](img/3_3_anti_tank/javelin FLTR locked.jpg){ width="600" }
/// caption
...
![Javelin FLTR](img/3_3_anti_tank/javelin FLTR locked seek.jpg){ width="600" }
/// caption
...
![Onbewapende Technical](img/3_3_anti_tank/technical onbewapend.jpg){ width="600" }
/// caption
Onbewapende technical: minimale dreiging. Rekening houden met infanterie die kan uitstappen.
///

![Technicals met .50](img/3_3_anti_tank/technical .50.jpg){ width="600" }
/// caption
...
![Technicals met AT, SPG of GMG](img/3_3_anti_tank/technical AT SPG GMG.jpg){ width="600" }
/// caption
Technicals met AT, SPG of GMG: zware dreiging door het AT wapen, de raket of granaatwerper. AT inzetten! 
///

![APC voertuigen](img/3_3_anti_tank/APC voertuigen.jpg){ width="600" }
/// caption
...
![AA voertuigen](img/3_3_anti_tank/AA voertuigen.jpg){ width="600" }
/// caption
...
![Tanks](img/3_3_anti_tank/Tanks.jpg){ width="600" }
/// caption
